  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active"  aria-current="page" href="facultiesp.php">Faculty</a>
        </li>
        <li class="nav-item">
...
<div>
	<h1 class="text-center">Faculties List</h1> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <a href="uteacher.php">Add Teacher</a>
</div>
<div>
<section>
