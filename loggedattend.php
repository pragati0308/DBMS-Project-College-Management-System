  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="loggedattend.php">Attendance</a>
        </li>
        <li class="nav-item">
...
$query = " SELECT * from uattendance where USN='$usn' ";
...
<section class="my-5">
  <div class="py-5">
    <h1 class="text-center">Attendance
    </h1> 
  </div>
...
<form action="/action_page.php">
  ...
  <label for="lname">Total Classes</label><br>
  <input type="text" id="lname" name="branch" value="<?php echo "$row[3]"; ?>" disabled><br><br>
  <label for="lname">Classes Attended</label><br>
  <input type="text" id="lname" name="sem" value="<?php echo "$row[4]"; ?>" disabled><br><br>
  <label for="lname">Percentage</label><br>
